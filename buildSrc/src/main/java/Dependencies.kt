object Dependencies {
    ...
    object Testing {
        ...
        const val JUNIT_EXT =
            "androidx.test.ext:junit:${Versions.JUNIT_ANDROID_EXT}"
        ...
        const val ANDROID_ARCH_TEST_CORE =
    ...
    object Mockito {
        ...
        const val MOCKK =
            "io.mockk:mockk:${Versions.MOCKITO_MOCK}"
    }
    ...
    object WorkManager {
        const val WORK_MANAGER_RUNTIME =
            "androidx.work:work-runtime:${Versions.WORK_MANAGER}"
